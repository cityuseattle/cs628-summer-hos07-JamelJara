// Display the list of available databases. (show dbs)

// Switch to a specific database or create aa new one. (use CS628Practice)
...
db.users.update({ name: 'user1'}, { $set: { age: 31 } })
...
// Find users with naames starting with 'u' or 'C'.
db.users.find({
    $or: [
